                    ...
                    <div className="lg:w-1/2 lg:mx-6">
                        ...
                        <div className="mt-6 space-y-8 md:mt-8">
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 font-medium tracking-wide text-md">
                                    3/93, Vidyasagar Colony, Ganguly Bagan, <br /> Kolkata, West Bengal 700047
                                </span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 font-medium tracking-wide text-md">+91 9748286770</span>
                            </p>
                            ...
                            <p className="flex items-start -mx-2">
                                ...
                                <span className="mx-2 text-gray-700 truncate w-72 font-medium tracking-wide text-md">thelim.forever@gmail.com</span>
                            </p>
                        </div>
                        ...
                        <div className="mt-6 w-80 md:mt-8">
                            ...
                            <div className="flex mt-4 -mx-1.5 ">
                                ...
                                <a className="mx-1.5 text-gray-400 transition-colors duration-300 transform hover:text-purple-600" href="#">
                                    <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div className="mt-8 lg:w-1/2 lg:mx-6">
                        <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white rounded-lg shadow-2xl lg:max-w-xl shadow-gray-300/50">
                            ...
                            <form className="mt-6">
                                ...
                                <button className="w-full px-6 py-3 mt-6 text-sm font-medium tracking-wide text-white capitalize bg-blue-500 rounded-md hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                    get in touch
                                </button>
                            </form>
                        </div>
