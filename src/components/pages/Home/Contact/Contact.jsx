    ...
    return (
        <section className="bg-white ">
            <div className="container px-6 py-12 mx-auto">
                <Title mainTitle="Get in touch" subTitle="Our friendly team is always here to chat." />
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-blue-500 font-medium tracking-wider font-sans "> thelim.forever@gmail.com</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-blue-500 font-medium tracking-wider font-sans ">3/93, Vidyasagar Colony, Ganguly Bagan, Kolkata, West Bengal 700047</p>
                    </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center">
                        ...
                        <p className="mt-2 text-blue-500 font-medium tracking-wider font-sans ">+91 9748286770</p>
                    </div>
                </div>
            </div>
        </section>
